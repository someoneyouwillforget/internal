...
-- Helper function for the signature thick white borders
...
function Library:CreateWindow(Settings)
    ...
    -- CONTENT CONTAINER (Collapses on Minimize)
    ...
    -- Manual Canvas Size Fix for Tabs
    ...
    ElementsArea.Position = UDim2.new(0, 12, 0, 75)
    ElementsArea.Size = UDim2.new(1, -24, 1, -100)
    ...
    function Window:CreateTab(Name)
        ...
        TabPage.BackgroundTransparency = 1; TabPage.Visible = false; TabPage.ScrollBarThickness = 2
        TabPage.ScrollBarImageColor3 = Theme.BorderColor
        ...
        -- Returning the Element Creator API
        return {
