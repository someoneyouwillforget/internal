...
function Library:CreateWindow(Settings)
    ...
    Main.Size = UDim2.new(0, 400, 0, 300) -- Restored Original Size
    ...
    function Window:CreateTab(Name)
        ...
        tStroke.Thickness = 1.5 -- Restored Border Tab thickness
        ...
        -- Keeps elements from touching the ceiling without changing their size
